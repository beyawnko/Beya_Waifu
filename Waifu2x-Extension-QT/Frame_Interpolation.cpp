...
// int MainWindow::FrameInterpolation_DetectGPU() -> Helper, but called by above, so effectively stubbed if on_pushButton_DetectGPU_VFI_clicked is.
// int MainWindow::FrameInterpolation_DetectGPU_finished() -> Helper, but called by above, so effectively stubbed.
