...
struct qt_meta_stringdata_CLASSRhiLiquidGlassItemENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSRhiLiquidGlassItemENDCLASS = QtMocHelpers::stringData(
    "RhiLiquidGlassItem",
    "backgroundChanged",
    "",
    "iorChanged",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSRhiLiquidGlassItemENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSRhiLiquidGlassItemENDCLASS_t qt_meta_stringdata_CLASSRhiLiquidGlassItemENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSRhiLiquidGlassItemENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject RhiLiquidGlassItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSRhiLiquidGlassItemENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSRhiLiquidGlassItemENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRhiLiquidGlassItemENDCLASS_t,
        // property 'background'
...
void *RhiLiquidGlassItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSRhiLiquidGlassItemENDCLASS.stringdata0))
